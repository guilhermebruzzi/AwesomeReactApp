## Custom
This repository and README was created with [create-react-app](https://github.com/facebookincubator/create-react-app)

I customized it after npm run eject by including:
* css modules
* react router
